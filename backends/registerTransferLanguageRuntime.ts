...
export const mallocWithSbrk: RuntimeFunctionGenerator = (bytesInWord, firstRegister, nextRegister) => {
...
export const mallocWithMmap: RuntimeFunctionGenerator = (bytesInWord, firstRegister, nextRegister) => {
    return switchableMallocImpl(
        bytesInWord,
        firstRegister,
        nextRegister,
...
export const verifyNoLeaks: RuntimeFunctionGenerator = (bytesInWord, firstRegister, nextRegister) => {
    const currentBlockPointer = firstRegister;
